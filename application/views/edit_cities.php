                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Edit Cities</h4>
                        </div>
                    ...
                    <div class="col-md-4 col-lg-3" >
                        ...
                        <div class="col-md-6">
                            <div class="white-box">
                                ...
                                <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>membership/cities_update">
                                    <?php
foreach ($rec as $us) {
	?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="state_id"  id="state_id"   class="form-control" style="width: 400px ; margin-top: 20px">
                                            <?php foreach ($states as $m): ?>
                                            <option value="<?=$m->id;?>"
                                                <?php if ($us->state_id == $m->id): ?> selected<?php endif;?>
                                            >
                                                <?=$m->name?>
                                            </option>
                                        <?php endforeach;?>
