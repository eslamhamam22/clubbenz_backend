...
<div class="navbar-default sidebar" role="navigation">
   <div class="sidebar-nav slimscrollsidebar" style="overflow: hidden; width: auto; height: 100%;">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li> <a href="<?php echo base_url('/dashboard') ?>" class="waves-effect active"><i class="mdi mdi-av-timer fa-fw" data-icon="v"></i> <span class="hide-menu"> Dashboard <span class="fa arrow"></span> <span class="label label-rouded label-inverse pull-right"></span></span></a></li>
            <?php }if (in_array('Preferances/active', $c_a) || in_array('Advertisement/active', $c_a) || $group_id[0]->name == 'admin') {
	?>
            <li>
                <a href="index.html" class="waves-effect"><i data-icon="" class="linea-icon linea-basic fa-fw">P</i> <span class="hide-menu">Preferances <span class="fa arrow"></span> <span class="label label-rouded label-inverse pull-right"></span></span></a>
	...
	if (in_array('Preferances/active', $c_a) || $group_id[0]->name == 'admin') {
		?>
                      <li class="">
                        ...
                        <li> <a href="<?php echo base_url() ?>fuel/"><i data-icon="" class="mdi mdi-gas-station fa-fw"></i><span class="hide-menu"> Fule Type</span></a> </li>
	...
	if (in_array('Preferances/active', $c_a) || $group_id[0]->name == 'admin') {
		?>
                    <li>
                        ...
                        <?php
if (in_array('Preferances/active', $c_a) || $group_id[0]->name == 'admin') {?><li> <a href="<?php echo base_url() ?>service_tag/"><i data-icon="" class=" mdi mdi-settings fa-fw"></i><span class="hide-menu">Service Tags</span></a> </li>  <?php }
		...
		?>
                ...
                <?php }
	if (in_array('Preferances/active', $c_a) || $group_id[0]->name == 'admin') {?>
                    <li> <a href="<?php echo base_url() ?>profile_image/"><i data-icon="" class="ti-image fa-fw"></i><span class="hide-menu">Manage Profiel Image</span></a> </li> <?php }
	if (in_array('Partgroup/active', $c_a) || $group_id[0]->name == 'admin') {?>
                    <li>  </li><?php }
	if (in_array('Advertisement/active', $c_a) || $group_id[0]->name == 'admin') {?>
                    <li> <a href="<?php echo base_url() ?>advertisement/"class="waves-effect"><i class="" data-icon="">A</i> <span class="hide-menu"> Advertisement <span class="fa arrow"></span> <span class="label label-rouded label-inverse pull-right"></span></span></a></li><?php }?>
                </ul>
...
if (in_array('Listing/active', $c_a) || $group_id[0]->name == 'Part_Providers' || $group_id[0]->name == 'admin') {
	?>
            <li>
                ...
                <ul class="nav nav-second-level collapse <?php if ($this->uri->segment(1) == 'cars' || $this->uri->segment(1) == 'workshop' || $this->uri->segment(1) == 'partshop' || $this->uri->segment(1) == 'serviceshop' || $this->uri->segment(1) == 'part' || $this->uri->segment(1) == 'car_guide') {?>in<?php }?>">
                <?php
if ($group_id[0]->name == 'Part_Providers') {
		...
		if (in_array('Listing/active', $c_a) || $group_id[0]->name == 'admin') {?><li> <a href="<?php echo base_url() ?>cars/"><i data-icon="" class=" fa-fw mdi mdi-car"></i><span class="hide-menu">Listing Cars</span></a> </li><?php }
		if (in_array('Listing/active', $c_a) || $group_id[0]->name == 'admin') {?><li> <a href="<?php echo base_url() ?>workshop/"><i data-icon="" class="icon-wrench fa-fw"></i><span class="hide-menu">Listing WorksShops</span></a> </li>   <?php }
		if (in_array('Listing/active', $c_a) || $group_id[0]->name == 'admin') {?><li> <a href="<?php echo base_url() ?>partshop/"><i data-icon="" class="linea-icon linea-basic fa-fw">P</i><span class="hide-menu">Listing PartsShop</span></a> </li><?php }
		if (in_array('Listing/active', $c_a) || $group_id[0]->name == 'admin') {?><li> <a href="<?php echo base_url() ?>serviceshop/"><i data-icon="" class="mdi mdi-settings-box fa-fw"></i><span class="hide-menu">Listing Service Shops</span></a> </li> <?php }
		if (in_array('Listing/active', $c_a) || $group_id[0]->name == 'admin') {?><li> <a href="<?php echo base_url() ?>part/"><i data-icon="" class="linea-icon linea-basic fa-fw">P</i><span class="hide-menu">Listing Parts</span></a> </li><?php }
	}
	...
	?>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <?php if (in_array('plan/active', $c_a) || $group_id[0]->name == 'admin') {?><li> <a href="<?php echo base_url() ?>plan/"class="waves-effect"><i data-icon="" class="linea-icon linea-basic fa-fw">P</i> <span class="hide-menu">Plans <span class="label label-rouded label-inverse pull-right"></span></span></a></li> <?php }?>

                    <?php if (in_array('providerlist/active', $c_a) || $group_id[0]->name == 'admin') {?><li> <a href="<?php echo base_url() ?>providerlist/"class="waves-effect"><i data-icon="" class="linea-icon linea-basic fa-fw">P</i> <span class="hide-menu">Provider List  <span class="label label-rouded label-inverse pull-right"></span></span></a></li> <?php }?>


                    <?php if (in_array('shippment/active', $c_a) || $group_id[0]->name == 'admin') {?><li> <a href="<?php echo base_url() ?>shippment/"class="waves-effect"><i data-icon="" class="linea-icon linea-basic fa-fw">P</i> <span class="hide-menu">Shippment<span class="label label-rouded label-inverse pull-right"></span></span></a></li> <?php }?>
