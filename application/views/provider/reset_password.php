    ...
    <section id="wrapper" class="new-login-register">
      ...
      <div class="new-login-box">
        <div class="white-box">
          ...
          <form class="form-horizontal new-lg-form" method="post"  action="<?php echo base_url('provider/auth/confirmupdatepassword'); ?>" onsubmit="return validatePasseord()">

            <div class="form-group  m-t-20">
              <div class="col-xs-12">
                <label>Password</label>
                <input class="form-control" type="password" required="" name="user_password"  id="password"  placeholder="Password" value="">
              </div>
            </div>
