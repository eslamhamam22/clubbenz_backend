				...
				<form enctype="multipart/form-data" class="col-xs-12 form-horizontal new-lg-form" method="post" id="loginform" action="<?php echo base_url('provider/provider/edit'); ?>">
					...
					<div class="form-group">
						<div class="col-xs-12">
							...
							<input class="form-control" type="password" name="user_password" placeholder="Leave empty if you don't want to change it">
						</div>
					</div>
					<div class="form-group">
						<div class="col-xs-12">
					...
					<div class="form-group text-center m-t-20">
						<div class="col-xs-12">
							<button class="btn btn-info btn-lg btn-block btn-rounded text-uppercase waves-effect waves-light" type="submit">Save</button>
						</div>
					</div>
				</form>
			</div>
