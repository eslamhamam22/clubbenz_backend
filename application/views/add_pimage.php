                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Add Profile Image</h4>
                        </div>
                    ...
                    <div class="col-md-4 col-lg-3" >
                        ...
                        <div class="col-md-6">
                            <div class="white-box">
                                ...
                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>profile_image/add_pimage">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="hidden" name="model_name_arabic" class="form-control" id="mname" placeholder="Model Name Arabic" required> </div>
                                    </div>
