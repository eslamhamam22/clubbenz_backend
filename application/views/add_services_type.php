                    ...
                    <div class="col-md-4 col-lg-3" >
                        ...
                        <div class="col-md-6">
                            <div class="white-box">
                                ...
                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>service_tag/add_services_type">
                                    <div class="form-group">
    									<label for="inputEmail3" class="col-sm-3 control-label"> service group Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="name" class="form-control" placeholder="Enter service group Name">
                                       </div>
                                    </div>
