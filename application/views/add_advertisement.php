                    ...
                    <div class="col-md-4 col-lg-3" >
                        ...
                        <div class="col-md-6">
                            <div class="white-box">
                                ...
                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>advertisement/add_advertisement">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="pagename" class="form-control" id="mname" placeholder="page name" required> </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-3 control-label">Link</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="link" class="form-control" id="mname" placeholder="Link" required> </div>
                                    </div>
