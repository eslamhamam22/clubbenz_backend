...
foreach ($rec as $us) {?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="user_name" class="form-control" id="user_name"value="<?php echo $us->user_name; ?>"> </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-3 control-label"> Email</label>
                                        <div class="col-sm-9">
                                            <input type="email" name="user_email" class="form-control" id="user_email"value="<?php echo $us->user_email; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="user_mobile" class="form-control" value="<?php echo $us->user_mobile ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="store_name" class="form-control" value="<?php echo $us->store_name ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="contact_person" class="form-control" value="<?php echo $us->contact_person ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="country" class="form-control" value="<?php echo $us->country ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="governorate" class="form-control" value="<?php echo $us->governorate ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="city" class="form-control" value="<?php echo $us->city ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="zip_code" class="form-control" value="<?php echo $us->zip_code ?>" required>
                                        </div>
                                    </div>
