					...
					<div id="edit_role" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" style="display: none;">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form name="" method="post"type="" scope="" action="<?php echo base_url('/part_photos/update_part_photos') ?>" enctype="multipart/form-data">
                            ...
                            <div class="row margin-top">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="username" class="form-control" value="<?php echo $rec->username ?>" readonly> </div>
                                    </div>
                                </div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="email" name="email" class="form-control" value="<?php echo $rec->email ?>" readonly> </div>
									</div>
                            ...
                            <div class="row margin-top">
                                ...
                                <div class="col-md-6" >
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="phone" class="form-control" value="<?php echo $rec->phone ?>" > </div>
                                    </div>
                                </div>
