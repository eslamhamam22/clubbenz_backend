        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-md-4 col-lg-3" >
                 ...
                 <div class="col-md-6">
                    <div class="white-box">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>brand/update_brand">
                            <?php
                                foreach($rec as $us){
                            ?>
                             ...
                             <div class="form-group" style="padding-left: 200px">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="arabic_name" class="form-control"  placeholder="Part Arabic Name" value="<?php echo $us->arabic_name; ?>"> 
                                    </div>
                                </div>   
