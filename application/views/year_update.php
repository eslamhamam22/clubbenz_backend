                        ...
                        <div class="white-box">
                            ...
                            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>years/year_update_value">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="year" class="form-control" value="<?php echo $year->name ?>"required> </div>

                                        <input type="hidden" name="id" class="form-control" value="<?php echo $year->id ?>">
                                </div>
                                <div class="form-group">
                                        <label  class="col-sm-3 control-label"> Sorting</label>
                                        <div class="col-sm-9">
                                            <input type="text" id="sorting" name="sorting" class="form-control" id="inputEmail3" value="<?php echo $year->sorting ?>" required> </div>
                                    </div>
