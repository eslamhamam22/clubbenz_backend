...
?>
                ...
                <div class="panel-body">
                    <form role="form" method="post" action="<?php echo base_url('provider/login_user'); ?>">
                        <fieldset>
                ...
                <center><b>You are not registered ?</b> <br></b><a href="<?php echo base_url('provider'); ?>">Register here</a></center><!--for centered text-->
