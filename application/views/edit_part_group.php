            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edit Part Group</h4>
                    </div>
                ...
                <div class="col-md-4 col-lg-3" >
                 ...
                 <div class="col-md-6">
                    <div class="white-box">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>partgroup/update_part_group">
                            <?php
                                foreach($rec as $us){
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="name" class="form-control"  placeholder="Part Name" value="<?php echo $us->name; ?>"required> 
                                    </div>
                                </div>
