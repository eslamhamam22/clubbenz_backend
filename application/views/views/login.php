...
<link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/css/colors/default.css">
...
<script type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/js/jquery.slimscroll.js"></script>
<!--Wave Effects -->
<!-- <script src="js/waves.js"></script> -->
<script type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/js/waves.js"></script>
<!-- Custom Theme JavaScript -->
<!-- <script src="js/custom.min.js"></script> -->
<script type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/js/custom.min.js"></script>
<!--Style Switcher -->
